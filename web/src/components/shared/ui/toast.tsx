...
>(({ className, ...props }, ref) => (
  <ToastPrimitive.Viewport
    ref={ref}
    className={cn(
      'fixed top-0 left-1/2 z-[100] m-[var(--space-4)] flex max-h-screen w-[360px] max-w-[calc(100vw-1.5rem)] -translate-x-1/2 flex-col gap-[var(--space-2)] outline-none',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <ToastPrimitive.Title
    ref={ref}
    className={cn(
      'font-display text-[var(--ui-text-sm)] font-extrabold uppercase tracking-wide',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <ToastPrimitive.Description
    ref={ref}
    className={cn('font-body text-[var(--ui-text-sm)]', className)}
    {...props}
  />
));
